    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/css/**", "/js/**", "/img/**", "/trang-chu", "/cua-hang", "/thong-tin-san-pham", "/gioi-thieu", "/lien-he", "/oauth/**", "/register", "/error",
                                "/products", "/cart", "/cart/**", "/auth/**")
                ...
                .formLogin(formLogin -> formLogin
                        ...
                        .defaultSuccessUrl("/trang-chu") // Trang sau đăng nhập thành công.
